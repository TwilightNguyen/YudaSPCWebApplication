...
namespace YudaSPCWebApplication.BackendServer.Controllers
{
    ...
    public class EventLogController(
        ...
        IClientIpAccessorService ipAccessor

    ) : ControllerBase
    {
        private readonly ApplicationDbContext _context = context;
        private readonly ILogger<EventLogController> _logger = logger;
        private readonly IClientIpAccessorService _ipAccessor = ipAccessor;
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<IActionResult> CreateEventLog([FromBody] EventLogCreateRequest request)
        {
            return Ok(_ipAccessor.GetClientIp() ?? "Unknown");
